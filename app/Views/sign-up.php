              ...
              <div class="card card-plain mt-5">
                ...
                <div class="card-body">
                  <form role="form" method="POST" action="<?=base_url('register')?>">
                    ...
                    <div class="mb-3">
                      <input type="text" class="form-control" name="fullname" value="<?=old('fullname')?>" placeholder="Fullname" aria-label="Fullname" aria-describedby="fullname-addon" required/>
                    ...
                    <div class="mb-3">
                      ...
                      <div class="text-danger"><small><?=isset($validation)? display_error($validation,'school') : '' ?></small></div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      <input type="password" class="form-control" name="confirm_password" placeholder="Confirm Password" aria-label="Password" aria-describedby="password-addon" required/>
                      <div class="text-danger"><small><?=isset($validation)? display_error($validation,'confirm_password') : '' ?></small></div>
                    </div>
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    ...
                    <a href="<?=site_url('/')?>" class="text-info text-gradient font-weight-bold">Sign in</a>
                  </p>
                </div>
              </div>
            </div>
