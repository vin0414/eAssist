                            ...
                            <div class="card card-plain mt-5">
                                <div class="card-header pb-0 text-center bg-transparent">
                                    <img src="<?=base_url('assets/img/logos')?>/<?=isset($about['systemLogo']) ? $about['systemLogo'] : "No Logo"?>"
                                        width="100px" />
                                    <h5 class="font-weight-bolder text-info text-gradient">Register account to use
                                        <?=isset($about['systemTitle']) ? $about['systemTitle'] : "No Application Title"?>
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <form role="form" method="POST" action="<?=base_url('register')?>">
                                        ...
                                        <div class="mb-3">
                                            <input type="text" class="form-control" name="fullname"
                                                ...
                                                aria-label="Fullname" aria-describedby="fullname-addon" required />
                                            <div class="text-danger">
                                                <small><?=isset($validation)? display_error($validation,'fullname') : '' ?></small>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" class="form-control" name="position"
                                                value="<?=old('position')?>" placeholder="Position"
                                                aria-label="Position" aria-describedby="position-addon" required />
                                            <div class="text-danger">
                                                <small><?=isset($validation)? display_error($validation,'position') : '' ?></small>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <div class="text-danger">
                                                <small><?=isset($validation)? display_error($validation,'school') : '' ?></small>
                                            </div>
                                        </div>
                                        <div class="mb-3">
