...
<body class="g-sidenav-show  bg-gray-100">
                                ...
                                <table class="table table-flush" id="datatable-search" style="font-size:12px;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?=site_url('edit-account/')?><?php echo $row->Token ?>"><i
                                                        class="fa-regular fa-pen-to-square"></i>&nbsp;Edit</a>&nbsp;
                                                <button type="button" class="badge bg-info reset"
                                                    value="<?php echo $row->accountID ?>"><i
    ...
    <div class="modal fade" id="addPasswordModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
