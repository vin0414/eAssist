                        ...
                        <div class="card-header p-3 pb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="<?=site_url('user-accounts')?>"
                                    class="btn btn-sm btn-info text-white ms-auto mb-0">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <select class="form-control" name="role" id="role" required>
                                                ...
                                                <option
                                                    <?php echo ($account['Role'] == "Administrator") ? 'selected' : ''; ?>>
                                                    Administrator</option>
                                                <option
                                                    <?php echo ($account['Role'] == "Manager") ? 'selected' : ''; ?>>
                                                    Manager</option>
                                                <option <?php echo ($account['Role'] == "User") ? 'selected' : ''; ?>>
                                                    User</option>
                                            </select>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-4">
                                            ...
                                            <select class="form-control" name="cluster">
                                                <option value="0"
                                                    <?php echo ($account['clusterID'] == 0) ? 'selected' : ''; ?>>Choose
                                                </option>
                                                <?php foreach($cluster as $row): ?>
                                                <option value="<?php echo $row['clusterID'] ?>"
                                                    <?php echo ($account['clusterID'] == $row['clusterID']) ? 'selected' : ''; ?>>
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <select class="form-control" name="school">
                                                <option value="0"
                                                    <?php echo ($account['schoolID'] == 0) ? 'selected' : ''; ?>>Choose
                                                </option>
                                                <?php foreach($school as $row): ?>
                                                <option value="<?php echo $row['schoolID'] ?>"
                                                    <?php echo ($account['schoolID'] == $row['schoolID']) ? 'selected' : ''; ?>>
