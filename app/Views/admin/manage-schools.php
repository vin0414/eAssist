...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
            ...
            <ul class="nav nav-tabs" id="myTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#home" role="tab"
                        aria-controls="home" aria-selected="true">Cluster</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="area-tab" data-bs-toggle="tab" href="#area" role="tab" aria-controls="area"
                        aria-selected="false">Area of Concerns</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#profile" role="tab"
                        aria-controls="profile" aria-selected="false">Schools</a>
                </li>
            </ul>
                                ...
                                <div class="card-header p-3 pb-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <button type="button" class="btn btn-sm btn-info text-white ms-auto mb-0"
                                            data-bs-toggle="modal" data-bs-target="#addClusterModal">
                                ...
                                <div class="card-body px-0 pt-0 pb-2">
                                    <div class="table-responsive p-0">
                                        <table class="table align-items-center mb-0" style="font-size:12px;">
                                            <thead>
                                                <th
                                                    class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 w-500">
                                                    Cluster Name</th>
                                                <th
                                                    class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 w-500">
                                                    Assigned PSDS</th>
                    ...
                    <div class="card">
                        <div class="card-header p-3 pb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-info text-white ms-auto mb-0"
                                    style="margin-right:5px;" data-bs-toggle="modal" data-bs-target="#addSchoolModal">
                                    <i class="fa-solid fa-plus"></i> New
                                </button>
                                <button type="button" class="btn btn-secondary btn-sm add mb-0" id="btnExport"><i
    ...
    <div class="modal fade" id="addClusterModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 form-group">
                                ...
                                <select class="form-control" name="cluster" required>
                                    ...
                                    <option value="<?php echo $row['clusterID'] ?>"><?php echo $row['clusterName'] ?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
    ...
    <div class="modal fade" id="editSchoolModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="editClusterModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    $(document).ready(function() {
        ...
        $('#frmEditCluster').on('submit', function(e) {
            ...
            let data = $(this).serialize();
            $.ajax({
                url: "<?=site_url('edit-cluster')?>",
                method: "POST",
                data: data,
                success: function(response) {
                    if (response.success) {
                        fetchCluster();
                        $('#frmEditCluster')[0].reset();
        ...
        $(document).on('click', '.save', function(e) {
            ...
            $('.error-message').html('');
            $.ajax({
                url: "<?=site_url('edit-school')?>",
                method: "POST",
                data: data,
                success: function(response) {
                    if (response.success) {
                        table.ajax.reload();
                        $('#frmEditSchool')[0].reset();
